...
export const AppStateContext = createContext<null | [StateProps, Dispatch<ActionProps>]>(null);

export const AppProvider = ({ children }: { children: ReactNode }) => {
   const [state, dispatch] = useReducer<Reducer<StateProps, ActionProps>>(stateReducer, {
      me: null,
      form: {},
      blog: null,
      restaurant: null,
